...
-- User generates a code in NOVAT Settings → Verbindungen, sends it to the bot,
-- backend (nova-server webhook) resolves the sender and sets profiles.phone_number.
