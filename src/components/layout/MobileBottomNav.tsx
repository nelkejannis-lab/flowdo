...
import { LayoutDashboard, ListTodo, CalendarClock, Trello, Menu } from 'lucide-react'
...
export default function MobileBottomNav({ onOpenMenu }: MobileBottomNavProps) {
  ...
  return (
    ...
    >
      ...
      <NavLink to="/termine" className={itemClass}>
        <CalendarClock size={20} />
        <span>Termine</span>
      </NavLink>
      <NavLink to="/projekte" className={itemClass}>
        <Trello size={20} />
        <span>{t('sidebar.projects.all')}</span>
      </NavLink>
